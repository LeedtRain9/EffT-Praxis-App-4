const questions = {
    ...
    Schützschaltungen: [
        ...
        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 3. Rechts eine entsprechende Umsetzung eines Teilnehmenden ohne vorherige Kenntnisse. Was denken Sie dazu?", 
            image: "Bilder Schützschaltungen/bild1.jpg", 
            answers: ["Sowas würde ich als Anfänger nicht abgeben", "Bis auf Kleinigkeiten bei der Leitungsführung wirklich super gelungen"], 
            correct: [1] 
        },

        { 
            type: "textWithImage", 
            question: "Was sollte hier getan werden, um ein aufpleisen der Adern zu verhindern?", 
            image: "Bilder Schützschaltungen/bild3.jpg", 
            answers: ["Aderendhülsen nutzen. Das muss man bei dieser Klemmenart nicht zwangsweise, aber zusätzlicher Vorteil ist zudem, dass das Einführen in die Durchgangsklemme mit 'Push-X-Technologie' auch ohne Werkzeug möglich ist", "Ich verdrille die Litze der Ader vorher und stopfe diese in die Reihenklemme (Durchgangsklemme)"], 
            correct: [0] 
        },

        { 
            type: "textWithImage", 
            question: "Was hat der Teilnehmende an der markierten Stelle vergessen? Vielleicht hilft ein Blick bei den beiden 3-er Blöcken rechts daneben.", 
            image: "Bilder Schützschaltungen/bild5.jpg", 
            answers: ["Einen Abschlussdeckel. Der muss in dieser Ausführung vorhanden sein, da sonst der Berührungsschutz nicht gegeben ist", "Ich muss einen Abschlussdeckel einbauen, damit sich die Klemmen nicht hin- und herschieben auf der Hutschieneeben"], 
            correct: [0] 
        },

        { 
            type: "textWithImage", 
            question: "Wie beurteilen Sie die Ausführung dieser Klemmleiste?", 
            image: "Bilder Schützschaltungen/bild6.jpg", 
            answers: ["Vollkathastrophe!!!", "Ich hätte versucht, die Leitungsführung ein stückweit gerader auszuführen, aber im Grunde super ausgeführt!!!"], 
            correct: [1] 
        },

        { 
            type: "textWithImage", 
            question: "Was halten Sie von dieser Ausführung?", 
            image: "Bilder Schützschaltungen/bild7.jpg", 
            answers: ["Wirklich prima ausgeführt. Die Leiterisolierung berührt nicht das Panel und die Adern kommen von oben in die Klemme rein", "Auch links im Bild sieht die Leitungsführung mit leichtem Bogen super aus", "Leitungsverschwendung. Viel zu krumm"], 
            correct: [0, 1] 
        },

        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 4. Rechts eine entsprechende Umsetzung eines Teilnehmenden ohne vorherige Kenntnisse. Was denken Sie dazu?", 
            image: "Bilder Schützschaltungen/bild8.jpg", 
            answers: ["Prima. Da hat sich jemand wirklich Mühe gegeben!!!", "Das würde ich selbst als Anfänger nie abliefern!!!"], 
            correct: [0] 
        },
        ...
        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 4. Rechts eine entsprechende Umsetzung eines Teilnehmenden ohne vorherige Kenntnisse. Was denken Sie dazu?", 
            image: "Bilder Schützschaltungen/bild9.jpg", 
            answers: ["Beste Ausführung überhaupt!!!", "Wenn's mal schnell gehen muss, verlieren viele die Puste auf den letzten Metern. Zwar 'bestanden', aber es hätte ruhig ein bisschen besser aussehen dürfen!!!"], 
            correct: [1] 
        },

        { 
            type: "textWithImage", 
            question: "Links zu sehen eine Ausführung einer Schützschaltung. Wenn auch super ordentlich, worauf hätten Sie noch geachtet?", 
            image: "Bilder Schützschaltungen/bild10.jpg", 
            answers: ["Ich hätte die Abstände der Verdrahtungskanäle an der höchsten Breite eines der Betriebsmittel ausgerichtet. Dann gäbe es ein wenig mehr Spielraum", "Passt schon. Und was nicht passt, wird passend gemacht"], 
            correct: [0] 
        },

        { 
            type: "textWithImage", 
            question: "Links zu sehen das Schema der AP 4. Welches Betriebsmittel wurde falsch platziert?", 
            image: "Bilder Schützschaltungen/bild11.jpg", 
            answers: ["Der Motorschutzschalter ganz links", "Das Multifunktionsrelais / Zeitrelais. Das muss ganz rechts platziert werden"], 
            correct: [1] 
        },
...
function displayOverallScore() {
    ...
    if (medal === 'Platin') {
        const platinSound = new Audio('Aber Bitte Mit Sahne.mp3');
